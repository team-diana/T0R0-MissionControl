...
void ScientificDisplay::paintEvent (QPaintEvent *){
    ...
    drillInd[0]->setGeometry(10 ,200,DRILL_INDICATOR_DISPLAY_WIDTH+2, DRILL_INDICATOR_DISPLAY_HEIGHT+2);
    drillInd[1]->setGeometry(360,200,DRILL_INDICATOR_DISPLAY_WIDTH+2, DRILL_INDICATOR_DISPLAY_HEIGHT+2);
    proxInd->setGeometry    (150,200, PROXIMITY_SENSOR_INDICATOR_DISPLAY_WIDTH+2, PROXIMITY_SENSOR_INDICATOR_DISPLAY_HEIGHT+2);
}
